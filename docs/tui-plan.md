...
- **Dashboard view:** priority-sorted open-work list from `svc.List`. Columns: name, status, lead, priority, due date, next action. (Columns conditionally drop on smaller terminal widths). Use `bubbles/table`.
